...
osm-flyer: $(SRCDIR)osm-flyer.cpp FlyerWindow.o 
	$(CC) $(CFLAGS) -o osm-flyer FlyerWindow.o FlyerCamera.o FlyerMap.o FlyerMapBuilder.o FlyerMapBuilderThread.o OSMConnection.o FlyerConverter.o $(SRCDIR)osm-flyer.cpp $(LIBS) $(INCPATH) 
...
FlyerMapBuilder.o: $(SRCDIR)FlyerMapBuilder.cpp $(SRCDIR)FlyerMapBuilder.hpp FlyerMapBuilderThread.o
	$(CC) $(CFLAGS) -c $(SRCDIR)FlyerMapBuilder.cpp $(LIBS) $(INCPATH)

FlyerMapBuilderThread.o: $(SRCDIR)FlyerMapBuilderThread.cpp $(SRCDIR)FlyerMapBuilderThread.hpp OSMConnection.o
	$(CC) $(CFLAGS) -c $(SRCDIR)FlyerMapBuilderThread.cpp $(LIBS) $(INCPATH)
...
clean:
	rm osm-flyer FlyerWindow.o FlyerCamera.o FlyerMap.o FlyerMapBuilder.o FlyerMapBuilderThread.o OSMConnection.o FlyerConverter.o
